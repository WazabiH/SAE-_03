...
// Traitement de la suppression si un message est à supprimer
if (isset($_POST['supprimer_id'])) {
    $id = intval($_POST['supprimer_id']);
    $requete_suppression = "DELETE FROM message WHERE id = $id";
                ...
                <table class="w-full bg-white rounded-lg overflow-hidden border-collapse shadow">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="font-bold pl-8 py-5 text-left">Actions</th> <!-- Nouvelle colonne pour les actions -->
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr class="odd:bg-neutral-50 border-b-2 border-b-gray-100 last:border-b-0 first:border-t-2 first:border-t-gray-200">
                                ...
                                <td class="pl-8 p-4">
                                    <form method="post" class="inline">
                                        <input type="hidden" name="supprimer_id" value="<?php echo $element['id']; ?>">
                                        <button type="submit" class="font-bold text-red-600 ml-4">Supprimer</button>
                                    </form>
                                </td>
                            </tr>
                        <?php } ?>
